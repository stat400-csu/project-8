...
v3 <- c(0.025, 0, 0, 0, 1/3, 0, 0, 0, 0, 0, 0)
v4 <- c(0.025, 0, 0, 0, 1/3, 1/3, 0, 0, 0, 0, 0)
v5 <- c(0.025, 0, 0, 0, 1/3, 1/3, 1/3, 0, 0, 0, 0)
v6 <- c(0.025, 0, 0, 0, 0, 1/3, 1/3, 1/3, 0, 0, 0)
v7 <- c(0.025, 0, 0, 0, 0, 0, 1/3, 1/3, 1/3, 0, 0)
v8 <- c(0.025, 0, 0, 0, 0, 0, 0, 1/3, 1/3, 1/3, 0)
v9 <- c(0.025, 0, 0, 0, 0, 0, 0, 0, 1/3, 1/3, 1/2)
v10 <- c(0.025, 0, 0, 0, 0, 0, 0, 0, 0, 1/3, 1/2)
